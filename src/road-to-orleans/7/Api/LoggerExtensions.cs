...
public static partial class LoggerExtensions
{
    ...
    [LoggerMessage(EventId = 2000, Level = LogLevel.Error, Message = "Grain Canceled: {Message}")]
    public static partial void GrainCanceled(this ILogger logger, string message);

    [LoggerMessage(EventId = 2001, Level = LogLevel.Error, Message = "Grain error: {Message}")]
    ...
    public static partial void RunError(this ILogger logger, string err, Exception e);
